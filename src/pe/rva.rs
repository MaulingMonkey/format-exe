...
/// ≈ [u32] **R**elative **V**irtual **A**ddress: A (32-bit) offset from the base address of the loaded executable.<br>
/// May only allow a ≈ 2GiB (3**1**-bit) offset from said base, even in a 64-bit executable.<br>
/// <br>
///
